...
func (c *cli) serviceBootstrapCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			prof, err := c.handler.ServiceBootstrap(cmd.Context(), kubeconfigFlag, b, c.dockerfile, yesFlag)
			if err != nil {
				return err
			}
...
func (h *cliHandler) ServiceBootstrap(ctx context.Context, kubeconfig string, b platform.Bootstrapper, dockerfile []byte, yes bool) (*Profile, error) {
