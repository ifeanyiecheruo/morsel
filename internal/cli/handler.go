...
type Handler interface {
	...
	LoadProfile(name string, ensureValid bool) (*Profile, error)

	// No-auth commands
	ServiceBootstrap(ctx context.Context, platformName, kubeconfig string) error
	OperatorLogin(ctx context.Context) (*Profile, error)
...
func (h *cliHandler) LoadProfile(name string, _ bool) (*Profile, error) {
